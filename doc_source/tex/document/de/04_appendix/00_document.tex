...
Wenn es sich also z.B. um ein KNN handelt und dieses trainiert wird, um drei Klassen (Apfe, Birne, Zitrone) zu unterscheiden und
...
\begin{align}
    ...
    H(P,Q) = - (0 \cdot log(0.2) + 1 \cdot log(0.7) + P(0) \cdot log(0.1))\\
...
sehr einfach anhand der Entropie gezeigt werden. Man nehme bei die Wahrscheinlichkeitsverteilung $P$ für die Ereignisse $x_1 \cdots x_n$ die
folgenden Wahrscheinlichkeiten an: $(p_1, \cdots p_k \cdots p_n)$ wobei $p_k = 1$ und $p_{k \neq p} = 0$ gilt.
